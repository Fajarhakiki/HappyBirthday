package com.fajarhakiki.happybirthday
...
import com.fajarhakiki.happybirthday.ui.theme.HappyBirthdayTheme
...
fun BirthdayCard(name: String, age: Int, modifier: Modifier = Modifier) {
    Box(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.icon_cake), // Ganti dengan ikon yang tersedia di drawable
            ...
            Text(
                text = "Semoga Sukses Terus Ya $age!",
                fontSize = 22.sp,
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        BirthdayCard(name = "Fajar Hakiki", age = 19)
    }
}
